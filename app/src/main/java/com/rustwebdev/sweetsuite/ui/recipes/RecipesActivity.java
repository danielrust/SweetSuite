...
public class RecipesActivity extends AppCompatActivity implements RecipesViewContract.View {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    RecipesPresenter recipesPresenter = new RecipesPresenter(this, Injector.provideRecipeService(),
  ...
  @Override public void showRecipes(List<Recipe> recipes) {
    ...
    Log.d(LOG_TAG, "showrecipes was called: " + recipes);
    recipeArrayList = (ArrayList<Recipe>) recipes;
    recipesAdapter.changedData((ArrayList<Recipe>) recipes);
  }
